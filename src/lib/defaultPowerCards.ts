...
export const DEFAULT_POWER_CARDS: DefaultPowerCard[] = [
  ...
  { id: "shield", icon: "🛡", name: "Shield", description: "Protect from one wrong answer", category: "DEFENSE", rarity: "RARE", effectType: "BLOCK_NEGATIVE", price: 1500 },
  { id: "insurance", icon: "🛡", name: "Insurance", description: "Block negative points for limited questions", category: "DEFENSE", rarity: "COMMON", effectType: "BLOCK_NEGATIVE", price: 900 },
  ...
  { id: "bonus-multiplier", icon: "⭐", name: "Bonus Multiplier", description: "Increase earned points", category: "BOOST", rarity: "RARE", effectType: "DOUBLE_SCORE", price: 1400 },
